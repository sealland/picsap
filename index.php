...
<body>
    ...
    $material_data = array(
        ...
        'name' => isset($show['MAT_NAME']) ? $show['MAT_NAME'] : '',
        'group' => isset($show['MAT_GROUP']) ? $show['MAT_GROUP'] : '',
        'size' => isset($show['MAT_SIZE']) ? $show['MAT_SIZE'] : '',
        'requester' => isset($show['REQUISTIONER']) ? $show['REQUISTIONER'] : '',
